...
Run.prototype.run = function () {
  ...
  me.tasks = [];
  if (!me.parent)
    me.tasks.push.apply( me.tasks, me.tally.list('parent emit') );


  _.each(me.names, function (name) {
    me.tasks.push.apply(me.tasks, me.tally.list('before ' + name));
    me.tasks.push.apply(me.tasks, me.tally.list(            name));
    me.tasks.push.apply(me.tasks, me.tally.list('after '  + name));
  });
