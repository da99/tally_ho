...
Run.prototype.run = function () {
  ...
  _.each(me.proc_list, function (name) {
    ...
    me.tasks.push(me.tally.list_with_includes('before ' + name));
    me.tasks.push(me.tally.list_with_includes(            name));
    me.tasks.push(me.tally.list_with_includes('after '  + name));
  });
